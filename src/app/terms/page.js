  ...
  return (
    <div className={basicStyles.container}>
      ...
      <main className={styles["main"]}>
        ...
        <h3>제1조 (목적)</h3>
        <p>
          본 약관은 DREAMER가 제공하는 꿈 기록 및 공유 서비스(이하 "서비스"라
          함)의 이용과 관련하여 팀 DREAMER와 회원의 권리, 의무 및 책임사항을
          규정함을 목적으로 합니다.
        </p>
        <h3>제2조 (정의)</h3>
        <ol>
          ...
          <li>
            "회원"이란 본 약관에 동의하고 팀 DREAMER와 서비스 이용계약을 체결한
            자를 말합니다.
          </li>
          <li>
            "게시물"이란 회원이 서비스에 게시한 모든 형태의 글, 사진, 댓글 등을
            의미합니다.
          </li>
        </ol>
